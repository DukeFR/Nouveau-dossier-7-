...
class Svgfile
{
    public:
        ...
        void addEllipse(double x, double y, double rx, double ry, std::string color, double thickness, std::string colorStroke);
        void addTriangle(double x1, double y1, double x2, double y2,
                         double x3, double y3, std::string colorFill,
                          double thickness, std::string colorStroke);
        void addTriangle(double x1, double y1, double x2, double y2,
                         double x3, double y3, std::string colorFill=defcol);
        void addPentagone(double x1,double y1, double x2, double y2, double x3, double y3, double x4, double y4, double x5, double y5, std::string colorFill=defcol, std::string colorStroke=defcol);
        void addSquare(double x1, double y1, double x2, double y2,
