...
void Svgfile::addEllipse(double x, double y, double rx, double ry, std::string color, double thickness, std::string colorStroke)
{
    m_ostrm << "<ellipse "
            << attrib("cx", x)
            << attrib("cy", y)
...
void Svgfile::addPentagone(double x1,double y1, double x2, double y2, double x3, double y3, double x4, double y4,double x5,double y5, std::string colorFill, std::string colorStroke)
{
    addTriangle(x1,y1,x2,y2,x3,y3,colorFill);
    addTriangle(x2,y2,x3,y3,x4,y4,colorFill);
    addTriangle(x3,y3,x4,y4,x5,y5,colorFill);
    addLine(x2,y2,x3,y3,colorFill);
    addLine(x1,y1,x2,y2,colorStroke);
    addLine(x1,y1,x3,y3,colorStroke);
    addLine(x2,y2,x4,y4,colorStroke);
    addLine(x5,y5,x4,y4,colorStroke);
    addLine(x3,y3,x5,y5,colorStroke);
}

void Svgfile::addSquare(double x1, double y1, double x2, double y2,
                          double x3, double y3,double x4,double y4, std::string colorFill)
{
    addTriangle(x1,y1,x2,y2,x3,y3,colorFill);
    addTriangle(x2,y2,x3,y3,x4,y4,colorFill);
    addLine(x1,y1,x2,y2,colorFill);
    addLine(x1,y1,x3,y3,colorFill);
    addLine(x2,y2,x4,y4,colorFill);
    addLine(x3,y3,x4,y4,colorFill);
    addLine(x2,y2,x3,y3,colorFill);
}
